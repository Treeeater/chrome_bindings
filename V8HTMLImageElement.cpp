...
WrapperTypeInfo V8HTMLImageElement::info = { V8HTMLImageElement::GetTemplate, V8HTMLImageElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLImageElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLImageElement", V8HTMLElement::GetTemplate(), V8HTMLImageElement::internalFieldCount,
        HTMLImageElementAttrs, sizeof(HTMLImageElementAttrs) / sizeof(*HTMLImageElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLImageElementRawCache = createRawTemplate();
    return V8HTMLImageElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLImageElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLImageElementCache = ConfigureV8HTMLImageElementTemplate(GetRawTemplate());
    return V8HTMLImageElementCache;
}
