...
WrapperTypeInfo V8WebGLContextAttributes::info = { V8WebGLContextAttributes::GetTemplate, V8WebGLContextAttributes::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8WebGLContextAttributesTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "WebGLContextAttributes", v8::Persistent<v8::FunctionTemplate>(), V8WebGLContextAttributes::internalFieldCount,
        WebGLContextAttributesAttrs, sizeof(WebGLContextAttributesAttrs) / sizeof(*WebGLContextAttributesAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8WebGLContextAttributesRawCache = createRawTemplate();
    return V8WebGLContextAttributesRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8WebGLContextAttributes::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8WebGLContextAttributesCache = ConfigureV8WebGLContextAttributesTemplate(GetRawTemplate());
    return V8WebGLContextAttributesCache;
}
