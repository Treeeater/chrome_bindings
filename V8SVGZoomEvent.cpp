...
WrapperTypeInfo V8SVGZoomEvent::info = { V8SVGZoomEvent::GetTemplate, V8SVGZoomEvent::derefObject, 0 };
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGZoomEventRawCache = createRawTemplate();
    return V8SVGZoomEventRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGZoomEvent::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGZoomEventCache = ConfigureV8SVGZoomEventTemplate(GetRawTemplate());
    return V8SVGZoomEventCache;
}
