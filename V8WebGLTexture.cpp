...
WrapperTypeInfo V8WebGLTexture::info = { V8WebGLTexture::GetTemplate, V8WebGLTexture::derefObject, 0 };
...
WebGLTexture* V8WebGLTexture::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<WebGLTexture > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(WebGLTexture* impl)
{
    if (!impl)
        return v8::Null();
