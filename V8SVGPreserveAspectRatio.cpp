...
WrapperTypeInfo V8SVGPreserveAspectRatio::info = { V8SVGPreserveAspectRatio::GetTemplate, V8SVGPreserveAspectRatio::derefObject, 0 };
...
static v8::Handle<v8::Value> alignAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    V8SVGPODTypeWrapper<SVGPreserveAspectRatio>* impWrapper = V8SVGPODTypeWrapper<SVGPreserveAspectRatio>::toNative(info.Holder());
    SVGPreserveAspectRatio impInstance = *impWrapper;
...
static void alignAttrSetter(v8::Local<v8::String> name, v8::Local<v8::Value> value, const v8::AccessorInfo& info)
{
    ...
    V8SVGPODTypeWrapper<SVGPreserveAspectRatio>* wrapper = V8SVGPODTypeWrapper<SVGPreserveAspectRatio>::toNative(info.Holder());
    SVGPreserveAspectRatio impInstance = *wrapper;
    SVGPreserveAspectRatio* imp = &impInstance;
...
static const BatchedAttribute SVGPreserveAspectRatioAttrs[] = {
    ...
    // Attribute 'meetOrSlice' (Type: 'attribute' ExtAttr: '')
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGPreserveAspectRatioTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGPreserveAspectRatio", v8::Persistent<v8::FunctionTemplate>(), V8SVGPreserveAspectRatio::internalFieldCount,
        SVGPreserveAspectRatioAttrs, sizeof(SVGPreserveAspectRatioAttrs) / sizeof(*SVGPreserveAspectRatioAttrs),
        0, 0);
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, SVGPreserveAspectRatioConsts, sizeof(SVGPreserveAspectRatioConsts) / sizeof(*SVGPreserveAspectRatioConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGPreserveAspectRatioRawCache = createRawTemplate();
    return V8SVGPreserveAspectRatioRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGPreserveAspectRatio::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGPreserveAspectRatioCache = ConfigureV8SVGPreserveAspectRatioTemplate(GetRawTemplate());
    return V8SVGPreserveAspectRatioCache;
}

V8SVGPODTypeWrapper<SVGPreserveAspectRatio>* V8SVGPreserveAspectRatio::toNative(v8::Handle<v8::Object> object)
{
    return reinterpret_cast<V8SVGPODTypeWrapper<SVGPreserveAspectRatio>*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
}
...
v8::Handle<v8::Object> V8SVGPreserveAspectRatio::wrap(V8SVGPODTypeWrapper<SVGPreserveAspectRatio>* impl)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<V8SVGPODTypeWrapper<SVGPreserveAspectRatio> > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(V8SVGPODTypeWrapper<SVGPreserveAspectRatio>* impl)
{
    if (!impl)
        return v8::Null();
...
{
    static_cast<V8SVGPODTypeWrapper<SVGPreserveAspectRatio>*>(object)->deref();
}
