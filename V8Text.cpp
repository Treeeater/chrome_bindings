...
WrapperTypeInfo V8Text::info = { V8Text::GetTemplate, V8Text::derefObject, 0 };
...
static v8::Handle<v8::Value> replaceWholeTextCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, content, args[0]);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8TextTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "Text", V8CharacterData::GetTemplate(), V8Text::internalFieldCount,
        TextAttrs, sizeof(TextAttrs) / sizeof(*TextAttrs),
        TextCallbacks, sizeof(TextCallbacks) / sizeof(*TextCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8TextRawCache = createRawTemplate();
    return V8TextRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8Text::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8TextCache = ConfigureV8TextTemplate(GetRawTemplate());
    return V8TextCache;
}
