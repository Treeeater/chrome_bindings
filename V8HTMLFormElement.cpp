...
WrapperTypeInfo V8HTMLFormElement::info = { V8HTMLFormElement::GetTemplate, V8HTMLFormElement::derefObject, 0 };
...
static v8::Handle<v8::Value> actionAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    return getElementStringAttr(info, HTMLNames::actionAttr);
}
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLFormElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLFormElement", V8HTMLElement::GetTemplate(), V8HTMLFormElement::internalFieldCount,
        HTMLFormElementAttrs, sizeof(HTMLFormElementAttrs) / sizeof(*HTMLFormElementAttrs),
        HTMLFormElementCallbacks, sizeof(HTMLFormElementCallbacks) / sizeof(*HTMLFormElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLFormElementRawCache = createRawTemplate();
    return V8HTMLFormElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLFormElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLFormElementCache = ConfigureV8HTMLFormElementTemplate(GetRawTemplate());
    return V8HTMLFormElementCache;
}
