...
WrapperTypeInfo V8StyleSheet::info = { V8StyleSheet::GetTemplate, V8StyleSheet::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8StyleSheetTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "StyleSheet", v8::Persistent<v8::FunctionTemplate>(), V8StyleSheet::internalFieldCount,
        StyleSheetAttrs, sizeof(StyleSheetAttrs) / sizeof(*StyleSheetAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8StyleSheetRawCache = createRawTemplate();
    return V8StyleSheetRawCache;
}
