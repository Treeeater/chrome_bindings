...
WrapperTypeInfo V8NodeFilter::info = { V8NodeFilter::GetTemplate, V8NodeFilter::derefObject, 0 };
...
static v8::Handle<v8::Value> acceptNodeCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(Node*, n, V8Node::HasInstance(args[0]) ? V8Node::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8NodeFilterTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    ...
    batchConfigureConstants(desc, proto, NodeFilterConsts, sizeof(NodeFilterConsts) / sizeof(*NodeFilterConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8NodeFilterRawCache = createRawTemplate();
    return V8NodeFilterRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8NodeFilter::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8NodeFilterCache = ConfigureV8NodeFilterTemplate(GetRawTemplate());
    return V8NodeFilterCache;
}
