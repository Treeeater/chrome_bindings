...
WrapperTypeInfo V8HTMLFrameElement::info = { V8HTMLFrameElement::GetTemplate, V8HTMLFrameElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLFrameElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLFrameElement", V8HTMLElement::GetTemplate(), V8HTMLFrameElement::internalFieldCount,
        HTMLFrameElementAttrs, sizeof(HTMLFrameElementAttrs) / sizeof(*HTMLFrameElementAttrs),
        HTMLFrameElementCallbacks, sizeof(HTMLFrameElementCallbacks) / sizeof(*HTMLFrameElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLFrameElementRawCache = createRawTemplate();
    return V8HTMLFrameElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLFrameElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLFrameElementCache = ConfigureV8HTMLFrameElementTemplate(GetRawTemplate());
    return V8HTMLFrameElementCache;
}
