...
WrapperTypeInfo V8Event::info = { V8Event::GetTemplate, V8Event::derefObject, 0 };
...
static v8::Handle<v8::Value> initEventCallback(const v8::Arguments& args)
{
    ...
    Event* imp = V8Event::toNative(args.Holder());
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, eventTypeArg, args[0]);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8EventTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "Event", v8::Persistent<v8::FunctionTemplate>(), V8Event::internalFieldCount,
        EventAttrs, sizeof(EventAttrs) / sizeof(*EventAttrs),
        EventCallbacks, sizeof(EventCallbacks) / sizeof(*EventCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, EventConsts, sizeof(EventConsts) / sizeof(*EventConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8EventRawCache = createRawTemplate();
    return V8EventRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8Event::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8EventCache = ConfigureV8EventTemplate(GetRawTemplate());
    return V8EventCache;
}
