...
WrapperTypeInfo V8CSSValue::info = { V8CSSValue::GetTemplate, V8CSSValue::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CSSValueTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "CSSValue", v8::Persistent<v8::FunctionTemplate>(), V8CSSValue::internalFieldCount,
        CSSValueAttrs, sizeof(CSSValueAttrs) / sizeof(*CSSValueAttrs),
        0, 0);
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, CSSValueConsts, sizeof(CSSValueConsts) / sizeof(*CSSValueConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSValueRawCache = createRawTemplate();
    return V8CSSValueRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8CSSValue::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSValueCache = ConfigureV8CSSValueTemplate(GetRawTemplate());
    return V8CSSValueCache;
}
