...
WrapperTypeInfo V8XPathResult::info = { V8XPathResult::GetTemplate, V8XPathResult::derefObject, 0 };
...
{
    static v8::Persistent<v8::FunctionTemplate> V8XPathResultRawCache = createRawTemplate();
    return V8XPathResultRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8XPathResult::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8XPathResultCache = ConfigureV8XPathResultTemplate(GetRawTemplate());
    return V8XPathResultCache;
}
