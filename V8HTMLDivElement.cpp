...
WrapperTypeInfo V8HTMLDivElement::info = { V8HTMLDivElement::GetTemplate, V8HTMLDivElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLDivElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLDivElement", V8HTMLElement::GetTemplate(), V8HTMLDivElement::internalFieldCount,
        HTMLDivElementAttrs, sizeof(HTMLDivElementAttrs) / sizeof(*HTMLDivElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLDivElementRawCache = createRawTemplate();
    return V8HTMLDivElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLDivElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLDivElementCache = ConfigureV8HTMLDivElementTemplate(GetRawTemplate());
    return V8HTMLDivElementCache;
}

HTMLDivElement* V8HTMLDivElement::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<HTMLDivElement > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(HTMLDivElement* impl)
{
    if (!impl)
        return v8::Null();
