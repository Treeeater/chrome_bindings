...
WrapperTypeInfo V8NodeIterator::info = { V8NodeIterator::GetTemplate, V8NodeIterator::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8NodeIteratorTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "NodeIterator", v8::Persistent<v8::FunctionTemplate>(), V8NodeIterator::internalFieldCount,
        NodeIteratorAttrs, sizeof(NodeIteratorAttrs) / sizeof(*NodeIteratorAttrs),
        NodeIteratorCallbacks, sizeof(NodeIteratorCallbacks) / sizeof(*NodeIteratorCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8NodeIteratorRawCache = createRawTemplate();
    return V8NodeIteratorRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8NodeIterator::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8NodeIteratorCache = ConfigureV8NodeIteratorTemplate(GetRawTemplate());
    return V8NodeIteratorCache;
}
