...
WrapperTypeInfo V8HTMLScriptElement::info = { V8HTMLScriptElement::GetTemplate, V8HTMLScriptElement::derefObject, 0 };
...
static void asyncAttrSetter(v8::Local<v8::String> name, v8::Local<v8::Value> value, const v8::AccessorInfo& info)
{
    ...
    imp->setBooleanAttribute(WebCore::HTMLNames::asyncAttr, v);
    return;
}
...
static const BatchedAttribute HTMLScriptElementAttrs[] = {
    ...
    // Attribute 'async' (Type: 'attribute' ExtAttr: 'Reflect')
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLScriptElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLScriptElement", V8HTMLElement::GetTemplate(), V8HTMLScriptElement::internalFieldCount,
        HTMLScriptElementAttrs, sizeof(HTMLScriptElementAttrs) / sizeof(*HTMLScriptElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLScriptElementRawCache = createRawTemplate();
    return V8HTMLScriptElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLScriptElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLScriptElementCache = ConfigureV8HTMLScriptElementTemplate(GetRawTemplate());
    return V8HTMLScriptElementCache;
}
