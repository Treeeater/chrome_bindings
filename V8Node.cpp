...
static v8::Handle<v8::Value> addEventListenerCallback(const v8::Arguments& args)
{
    ...
    if (listener) {
        ...
        createHiddenDependency(args.Holder(), args[1], V8Node::eventListenerCacheIndex);
    }
    return v8::Undefined();
}
...
static v8::Handle<v8::Value> removeEventListenerCallback(const v8::Arguments& args)
{
    ...
    if (listener) {
        ...
        removeHiddenDependency(args.Holder(), args[1], V8Node::eventListenerCacheIndex);
    }
    return v8::Undefined();
}
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8NodeTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "Node", v8::Persistent<v8::FunctionTemplate>(), V8Node::internalFieldCount,
        NodeAttrs, sizeof(NodeAttrs) / sizeof(*NodeAttrs),
        NodeCallbacks, sizeof(NodeCallbacks) / sizeof(*NodeCallbacks));
    ...
    batchConfigureConstants(desc, proto, NodeConsts, sizeof(NodeConsts) / sizeof(*NodeConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8NodeRawCache = createRawTemplate();
    return V8NodeRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8Node::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8NodeCache = ConfigureV8NodeTemplate(GetRawTemplate());
    return V8NodeCache;
}
