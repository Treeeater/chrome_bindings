...
WrapperTypeInfo V8SVGPaint::info = { V8SVGPaint::GetTemplate, V8SVGPaint::derefObject, 0 };
...
static v8::Handle<v8::Value> setUriCallback(const v8::Arguments& args)
{
    ...
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, uri, args[0]);
    imp->setUri(uri);
...
static v8::Handle<v8::Value> setPaintCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(SVGPaint::SVGPaintType, paintType, static_cast<SVGPaint::SVGPaintType>(args[0]->ToInt32()->Int32Value()));
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, uri, args[1]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, rgbColor, args[2]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, iccColor, args[3]);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGPaintTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGPaint", V8SVGColor::GetTemplate(), V8SVGPaint::internalFieldCount,
        SVGPaintAttrs, sizeof(SVGPaintAttrs) / sizeof(*SVGPaintAttrs),
        SVGPaintCallbacks, sizeof(SVGPaintCallbacks) / sizeof(*SVGPaintCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, SVGPaintConsts, sizeof(SVGPaintConsts) / sizeof(*SVGPaintConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGPaintRawCache = createRawTemplate();
    return V8SVGPaintRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGPaint::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGPaintCache = ConfigureV8SVGPaintTemplate(GetRawTemplate());
    return V8SVGPaintCache;
}
