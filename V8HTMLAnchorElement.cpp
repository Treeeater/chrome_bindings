...
WrapperTypeInfo V8HTMLAnchorElement::info = { V8HTMLAnchorElement::GetTemplate, V8HTMLAnchorElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLAnchorElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLAnchorElement", V8HTMLElement::GetTemplate(), V8HTMLAnchorElement::internalFieldCount,
        HTMLAnchorElementAttrs, sizeof(HTMLAnchorElementAttrs) / sizeof(*HTMLAnchorElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLAnchorElementRawCache = createRawTemplate();
    return V8HTMLAnchorElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLAnchorElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLAnchorElementCache = ConfigureV8HTMLAnchorElementTemplate(GetRawTemplate());
    return V8HTMLAnchorElementCache;
}
