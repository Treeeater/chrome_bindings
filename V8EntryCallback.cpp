...
V8EntryCallback::V8EntryCallback(v8::Local<v8::Object> callback, ScriptExecutionContext* context)
...
bool V8EntryCallback::handleEvent(Entry* entry)
{
    ...
    v8::Handle<v8::Value> entryHandle = toV8(entry);
