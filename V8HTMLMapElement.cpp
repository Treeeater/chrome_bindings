...
WrapperTypeInfo V8HTMLMapElement::info = { V8HTMLMapElement::GetTemplate, V8HTMLMapElement::derefObject, 0 };
...
static const BatchedAttribute HTMLMapElementAttrs[] = {
    // Attribute 'areas' (Type: 'readonly attribute' ExtAttr: '')
    {"areas", HTMLMapElementInternal::areasAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'name' (Type: 'attribute' ExtAttr: 'Reflect')
    {"name", HTMLMapElementInternal::nameAttrGetter, HTMLMapElementInternal::nameAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLMapElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLMapElement", V8HTMLElement::GetTemplate(), V8HTMLMapElement::internalFieldCount,
        HTMLMapElementAttrs, sizeof(HTMLMapElementAttrs) / sizeof(*HTMLMapElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLMapElementRawCache = createRawTemplate();
    return V8HTMLMapElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLMapElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLMapElementCache = ConfigureV8HTMLMapElementTemplate(GetRawTemplate());
    return V8HTMLMapElementCache;
}
...
{
    static_cast<HTMLMapElement*>(object)->deref();
}
