...
WrapperTypeInfo V8SVGFETurbulenceElement::info = { V8SVGFETurbulenceElement::GetTemplate, V8SVGFETurbulenceElement::derefObject, 0 };
...
static v8::Handle<v8::Value> baseFrequencyXAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    PassRefPtr<SVGAnimatedNumber> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->baseFrequencyXAnimated(), context);
...
static v8::Handle<v8::Value> baseFrequencyYAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    SVGFETurbulenceElement* imp = V8SVGFETurbulenceElement::toNative(info.Holder());
    SVGElement* context = imp;
    PassRefPtr<SVGAnimatedNumber> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->baseFrequencyYAnimated(), context);
    return toV8(resultAsPassRefPtr);
}
...
static v8::Handle<v8::Value> numOctavesAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    SVGFETurbulenceElement* imp = V8SVGFETurbulenceElement::toNative(info.Holder());
    SVGElement* context = imp;
    PassRefPtr<SVGAnimatedInteger> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->numOctavesAnimated(), context);
    return toV8(resultAsPassRefPtr);
}
...
static v8::Handle<v8::Value> seedAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    SVGFETurbulenceElement* imp = V8SVGFETurbulenceElement::toNative(info.Holder());
    SVGElement* context = imp;
    PassRefPtr<SVGAnimatedNumber> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->seedAnimated(), context);
    return toV8(resultAsPassRefPtr);
}
...
static v8::Handle<v8::Value> stitchTilesAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    SVGFETurbulenceElement* imp = V8SVGFETurbulenceElement::toNative(info.Holder());
    SVGElement* context = imp;
    PassRefPtr<SVGAnimatedEnumeration> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->stitchTilesAnimated(), context);
    return toV8(resultAsPassRefPtr);
}
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGFETurbulenceElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGFETurbulenceElement", V8SVGElement::GetTemplate(), V8SVGFETurbulenceElement::internalFieldCount,
        SVGFETurbulenceElementAttrs, sizeof(SVGFETurbulenceElementAttrs) / sizeof(*SVGFETurbulenceElementAttrs),
        SVGFETurbulenceElementCallbacks, sizeof(SVGFETurbulenceElementCallbacks) / sizeof(*SVGFETurbulenceElementCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, SVGFETurbulenceElementConsts, sizeof(SVGFETurbulenceElementConsts) / sizeof(*SVGFETurbulenceElementConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGFETurbulenceElementRawCache = createRawTemplate();
    return V8SVGFETurbulenceElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGFETurbulenceElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGFETurbulenceElementCache = ConfigureV8SVGFETurbulenceElementTemplate(GetRawTemplate());
    return V8SVGFETurbulenceElementCache;
}

SVGFETurbulenceElement* V8SVGFETurbulenceElement::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<SVGFETurbulenceElement > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(SVGFETurbulenceElement* impl)
{
    if (!impl)
        return v8::Null();
