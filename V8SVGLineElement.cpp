...
WrapperTypeInfo V8SVGLineElement::info = { V8SVGLineElement::GetTemplate, V8SVGLineElement::derefObject, 0 };

namespace SVGLineElementInternal {

template <typename T> void V8_USE(T) { }

static v8::Handle<v8::Value> x1AttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    INC_STATS("DOM.SVGLineElement.x1._get");
...
{
    INC_STATS("DOM.SVGLineElement.y1._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
    SVGElement* context = imp;
...
{
    INC_STATS("DOM.SVGLineElement.x2._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
    SVGElement* context = imp;
...
{
    INC_STATS("DOM.SVGLineElement.requiredExtensions._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
    SVGElement* context = imp;
...
{
    INC_STATS("DOM.SVGLineElement.systemLanguage._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
    SVGElement* context = imp;
...
{
    INC_STATS("DOM.SVGLineElement.xmllang._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
...
{
    INC_STATS("DOM.SVGLineElement.xmllang._set");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
    V8Parameter<> v = value;
    imp->setXmllang(v);
    return;
...
{
    INC_STATS("DOM.SVGLineElement.xmlspace._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
...
{
    INC_STATS("DOM.SVGLineElement.externalResourcesRequired._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
    SVGElement* context = imp;
...
{
    INC_STATS("DOM.SVGLineElement.style._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
...
{
    INC_STATS("DOM.SVGLineElement.transform._get");
    SVGLineElement* imp = V8SVGLineElement::toNative(info.Holder());
    SVGElement* context = imp;
...
{
    INC_STATS("DOM.SVGLineElement.getCTM");
    SVGLineElement* imp = V8SVGLineElement::toNative(args.Holder());
...
static const BatchedAttribute SVGLineElementAttrs[] = {
    // Attribute 'x1' (Type: 'readonly attribute' ExtAttr: '')
    {"x1", SVGLineElementInternal::x1AttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'y1' (Type: 'readonly attribute' ExtAttr: '')
    {"y1", SVGLineElementInternal::y1AttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'x2' (Type: 'readonly attribute' ExtAttr: '')
    {"x2", SVGLineElementInternal::x2AttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'y2' (Type: 'readonly attribute' ExtAttr: '')
    {"y2", SVGLineElementInternal::y2AttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'requiredFeatures' (Type: 'readonly attribute' ExtAttr: '')
    {"requiredFeatures", SVGLineElementInternal::requiredFeaturesAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'requiredExtensions' (Type: 'readonly attribute' ExtAttr: '')
    {"requiredExtensions", SVGLineElementInternal::requiredExtensionsAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'systemLanguage' (Type: 'readonly attribute' ExtAttr: '')
    {"systemLanguage", SVGLineElementInternal::systemLanguageAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'xmllang' (Type: 'attribute' ExtAttr: '')
    {"xmllang", SVGLineElementInternal::xmllangAttrGetter, SVGLineElementInternal::xmllangAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'xmlspace' (Type: 'attribute' ExtAttr: '')
    {"xmlspace", SVGLineElementInternal::xmlspaceAttrGetter, SVGLineElementInternal::xmlspaceAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'externalResourcesRequired' (Type: 'readonly attribute' ExtAttr: '')
    {"externalResourcesRequired", SVGLineElementInternal::externalResourcesRequiredAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'className' (Type: 'readonly attribute' ExtAttr: '')
    {"className", SVGLineElementInternal::classNameAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'style' (Type: 'readonly attribute' ExtAttr: '')
    {"style", SVGLineElementInternal::styleAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'transform' (Type: 'readonly attribute' ExtAttr: '')
    {"transform", SVGLineElementInternal::transformAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'nearestViewportElement' (Type: 'readonly attribute' ExtAttr: '')
    {"nearestViewportElement", SVGLineElementInternal::nearestViewportElementAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'farthestViewportElement' (Type: 'readonly attribute' ExtAttr: '')
    {"farthestViewportElement", SVGLineElementInternal::farthestViewportElementAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
static const BatchedCallback SVGLineElementCallbacks[] = {
    {"hasExtension", SVGLineElementInternal::hasExtensionCallback},
    {"getPresentationAttribute", SVGLineElementInternal::getPresentationAttributeCallback},
    {"getBBox", SVGLineElementInternal::getBBoxCallback},
    {"getCTM", SVGLineElementInternal::getCTMCallback},
    {"getScreenCTM", SVGLineElementInternal::getScreenCTMCallback},
};
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGLineElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGLineElement", V8SVGElement::GetTemplate(), V8SVGLineElement::internalFieldCount,
        SVGLineElementAttrs, sizeof(SVGLineElementAttrs) / sizeof(*SVGLineElementAttrs),
        SVGLineElementCallbacks, sizeof(SVGLineElementCallbacks) / sizeof(*SVGLineElementCallbacks));
    ...
    proto->Set(v8::String::New("getTransformToElement"), v8::FunctionTemplate::New(SVGLineElementInternal::getTransformToElementCallback, v8::Handle<v8::Value>(), getTransformToElementSignature));
...
v8::Persistent<v8::FunctionTemplate> V8SVGLineElement::GetRawTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGLineElementRawCache = createRawTemplate();
    return V8SVGLineElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGLineElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGLineElementCache = ConfigureV8SVGLineElementTemplate(GetRawTemplate());
    return V8SVGLineElementCache;
}

SVGLineElement* V8SVGLineElement::toNative(v8::Handle<v8::Object> object)
{
    return reinterpret_cast<SVGLineElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
}

bool V8SVGLineElement::HasInstance(v8::Handle<v8::Value> value)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<SVGLineElement > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(SVGLineElement* impl)
{
    if (!impl)
        return v8::Null();
...
{
    static_cast<SVGLineElement*>(object)->deref();
}
