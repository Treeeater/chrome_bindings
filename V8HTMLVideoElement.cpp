...
WrapperTypeInfo V8HTMLVideoElement::info = { V8HTMLVideoElement::GetTemplate, V8HTMLVideoElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLVideoElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLVideoElement", V8HTMLMediaElement::GetTemplate(), V8HTMLVideoElement::internalFieldCount,
        HTMLVideoElementAttrs, sizeof(HTMLVideoElementAttrs) / sizeof(*HTMLVideoElementAttrs),
        HTMLVideoElementCallbacks, sizeof(HTMLVideoElementCallbacks) / sizeof(*HTMLVideoElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLVideoElementRawCache = createRawTemplate();
    return V8HTMLVideoElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLVideoElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLVideoElementCache = ConfigureV8HTMLVideoElementTemplate(GetRawTemplate());
    return V8HTMLVideoElementCache;
}
