...
WrapperTypeInfo V8HTMLObjectElement::info = { V8HTMLObjectElement::GetTemplate, V8HTMLObjectElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLObjectElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLObjectElement", V8HTMLElement::GetTemplate(), V8HTMLObjectElement::internalFieldCount,
        HTMLObjectElementAttrs, sizeof(HTMLObjectElementAttrs) / sizeof(*HTMLObjectElementAttrs),
        HTMLObjectElementCallbacks, sizeof(HTMLObjectElementCallbacks) / sizeof(*HTMLObjectElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLObjectElementRawCache = createRawTemplate();
    return V8HTMLObjectElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLObjectElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLObjectElementCache = ConfigureV8HTMLObjectElementTemplate(GetRawTemplate());
    return V8HTMLObjectElementCache;
}
