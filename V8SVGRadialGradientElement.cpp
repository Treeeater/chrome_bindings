...
WrapperTypeInfo V8SVGRadialGradientElement::info = { V8SVGRadialGradientElement::GetTemplate, V8SVGRadialGradientElement::derefObject, 0 };
...
static v8::Handle<v8::Value> fxAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    SVGRadialGradientElement* imp = V8SVGRadialGradientElement::toNative(info.Holder());
    SVGElement* context = imp;
    PassRefPtr<SVGAnimatedLength> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->fxAnimated(), context);
    return toV8(resultAsPassRefPtr);
}
...
static v8::Handle<v8::Value> fyAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    SVGRadialGradientElement* imp = V8SVGRadialGradientElement::toNative(info.Holder());
    SVGElement* context = imp;
    PassRefPtr<SVGAnimatedLength> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->fyAnimated(), context);
    return toV8(resultAsPassRefPtr);
}
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGRadialGradientElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGRadialGradientElement", V8SVGGradientElement::GetTemplate(), V8SVGRadialGradientElement::internalFieldCount,
        SVGRadialGradientElementAttrs, sizeof(SVGRadialGradientElementAttrs) / sizeof(*SVGRadialGradientElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGRadialGradientElementRawCache = createRawTemplate();
    return V8SVGRadialGradientElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGRadialGradientElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGRadialGradientElementCache = ConfigureV8SVGRadialGradientElementTemplate(GetRawTemplate());
    return V8SVGRadialGradientElementCache;
}

SVGRadialGradientElement* V8SVGRadialGradientElement::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<SVGRadialGradientElement > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(SVGRadialGradientElement* impl)
{
    if (!impl)
        return v8::Null();
