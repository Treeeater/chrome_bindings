...
WrapperTypeInfo V8HTMLIFrameElement::info = { V8HTMLIFrameElement::GetTemplate, V8HTMLIFrameElement::derefObject, 0 };
...
static const BatchedAttribute HTMLIFrameElementAttrs[] = {
    ...
    // Attribute 'src' (Type: 'attribute' ExtAttr: 'Reflect')
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLIFrameElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLIFrameElement", V8HTMLElement::GetTemplate(), V8HTMLIFrameElement::internalFieldCount,
        HTMLIFrameElementAttrs, sizeof(HTMLIFrameElementAttrs) / sizeof(*HTMLIFrameElementAttrs),
        HTMLIFrameElementCallbacks, sizeof(HTMLIFrameElementCallbacks) / sizeof(*HTMLIFrameElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLIFrameElementRawCache = createRawTemplate();
    return V8HTMLIFrameElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLIFrameElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLIFrameElementCache = ConfigureV8HTMLIFrameElementTemplate(GetRawTemplate());
    return V8HTMLIFrameElementCache;
}
