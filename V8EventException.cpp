...
WrapperTypeInfo V8EventException::info = { V8EventException::GetTemplate, V8EventException::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8EventExceptionTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "EventException", v8::Persistent<v8::FunctionTemplate>(), V8EventException::internalFieldCount,
        EventExceptionAttrs, sizeof(EventExceptionAttrs) / sizeof(*EventExceptionAttrs),
        0, 0);
    ...
    batchConfigureConstants(desc, proto, EventExceptionConsts, sizeof(EventExceptionConsts) / sizeof(*EventExceptionConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8EventExceptionRawCache = createRawTemplate();
    return V8EventExceptionRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8EventException::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8EventExceptionCache = ConfigureV8EventExceptionTemplate(GetRawTemplate());
    return V8EventExceptionCache;
}
