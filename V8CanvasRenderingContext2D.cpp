...
WrapperTypeInfo V8CanvasRenderingContext2D::info = { V8CanvasRenderingContext2D::GetTemplate, V8CanvasRenderingContext2D::derefObject, 0 };
...
static v8::Handle<v8::Value> transformCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, m11, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, m12, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, m21, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, m22, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, dx, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(float, dy, static_cast<float>(args[5]->NumberValue()));
...
static v8::Handle<v8::Value> createLinearGradientCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(float, x0, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, y0, static_cast<float>(args[1]->NumberValue()));
...
static v8::Handle<v8::Value> createRadialGradientCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, x0, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, y0, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, r0, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, x1, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, y1, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(float, r1, static_cast<float>(args[5]->NumberValue()));
...
static v8::Handle<v8::Value> clearRectCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, width, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, height, static_cast<float>(args[3]->NumberValue()));
...
static v8::Handle<v8::Value> quadraticCurveToCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, cpx, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, cpy, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, x, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[3]->NumberValue()));
...
static v8::Handle<v8::Value> bezierCurveToCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, cp1x, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, cp1y, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, cp2x, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, cp2y, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, x, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[5]->NumberValue()));
...
static v8::Handle<v8::Value> arcToCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(float, x1, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, y1, static_cast<float>(args[1]->NumberValue()));
    ...
    EXCEPTION_BLOCK(float, radius, static_cast<float>(args[4]->NumberValue()));
...
static v8::Handle<v8::Value> arcCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, x, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, radius, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, startAngle, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, endAngle, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(bool, anticlockwise, args[5]->BooleanValue());
...
static v8::Handle<v8::Value> setAlphaCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, alpha, static_cast<float>(args[0]->NumberValue()));
    imp->setAlpha(alpha);
    return v8::Handle<v8::Value>();
}
...
static v8::Handle<v8::Value> setCompositeOperationCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, compositeOperation, args[0]);
...
static v8::Handle<v8::Value> setLineWidthCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, width, static_cast<float>(args[0]->NumberValue()));
...
static v8::Handle<v8::Value> setLineCapCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, cap, args[0]);
    imp->setLineCap(cap);
    return v8::Handle<v8::Value>();
}
...
static v8::Handle<v8::Value> setLineJoinCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, join, args[0]);
...
static v8::Handle<v8::Value> setMiterLimitCallback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, limit, static_cast<float>(args[0]->NumberValue()));
...
static v8::Handle<v8::Value> fillTextCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, maxWidth, static_cast<float>(args[3]->NumberValue()));
...
static v8::Handle<v8::Value> setStrokeColor1Callback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, color, args[0]);
    if (args.Length() <= 1) {
        imp->setStrokeColor(color);
        return v8::Handle<v8::Value>();
    }
    EXCEPTION_BLOCK(float, alpha, static_cast<float>(args[1]->NumberValue()));
...
static v8::Handle<v8::Value> setStrokeColor2Callback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, grayLevel, static_cast<float>(args[0]->NumberValue()));
    if (args.Length() <= 1) {
...
static v8::Handle<v8::Value> setStrokeColor3Callback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, r, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, g, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, b, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, a, static_cast<float>(args[3]->NumberValue()));
...
static v8::Handle<v8::Value> setStrokeColor4Callback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, c, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, m, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, k, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, a, static_cast<float>(args[4]->NumberValue()));
...
static v8::Handle<v8::Value> strokeRectCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, lineWidth, static_cast<float>(args[4]->NumberValue()));
...
static v8::Handle<v8::Value> drawImage1Callback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(HTMLImageElement*, image, V8HTMLImageElement::HasInstance(args[0]) ? V8HTMLImageElement::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    EXCEPTION_BLOCK(float, x, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[2]->NumberValue()));
...
static v8::Handle<v8::Value> drawImage2Callback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, x, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, width, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, height, static_cast<float>(args[4]->NumberValue()));
...
static v8::Handle<v8::Value> drawImage3Callback(const v8::Arguments& args)
{
    ...
    {
    EXCEPTION_BLOCK(HTMLImageElement*, image, V8HTMLImageElement::HasInstance(args[0]) ? V8HTMLImageElement::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    EXCEPTION_BLOCK(float, sx, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, sy, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, sw, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, sh, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(float, dx, static_cast<float>(args[5]->NumberValue()));
    EXCEPTION_BLOCK(float, dy, static_cast<float>(args[6]->NumberValue()));
    EXCEPTION_BLOCK(float, dw, static_cast<float>(args[7]->NumberValue()));
    EXCEPTION_BLOCK(float, dh, static_cast<float>(args[8]->NumberValue()));
...
static v8::Handle<v8::Value> drawImage4Callback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(HTMLCanvasElement*, canvas, V8HTMLCanvasElement::HasInstance(args[0]) ? V8HTMLCanvasElement::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    EXCEPTION_BLOCK(float, x, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[2]->NumberValue()));
...
static v8::Handle<v8::Value> drawImage7Callback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(HTMLVideoElement*, video, V8HTMLVideoElement::HasInstance(args[0]) ? V8HTMLVideoElement::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    EXCEPTION_BLOCK(float, x, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[2]->NumberValue()));
...
static v8::Handle<v8::Value> drawImageFromRectCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, dw, static_cast<float>(args[7]->NumberValue()));
    EXCEPTION_BLOCK(float, dh, static_cast<float>(args[8]->NumberValue()));
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, compositeOperation, args[9]);
...
static v8::Handle<v8::Value> setShadow1Callback(const v8::Arguments& args)
{
    ...
    CanvasRenderingContext2D* imp = V8CanvasRenderingContext2D::toNative(args.Holder());
    EXCEPTION_BLOCK(float, width, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, height, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, blur, static_cast<float>(args[2]->NumberValue()));
    if (args.Length() <= 3) {
        imp->setShadow(width, height, blur);
        return v8::Handle<v8::Value>();
    }
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, color, args[3]);
    if (args.Length() <= 4) {
        imp->setShadow(width, height, blur, color);
        return v8::Handle<v8::Value>();
    }
    EXCEPTION_BLOCK(float, alpha, static_cast<float>(args[4]->NumberValue()));
...
static v8::Handle<v8::Value> setShadow2Callback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, height, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, blur, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, grayLevel, static_cast<float>(args[3]->NumberValue()));
    if (args.Length() <= 4) {
...
static v8::Handle<v8::Value> setShadow3Callback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, height, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, blur, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, r, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, g, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(float, b, static_cast<float>(args[5]->NumberValue()));
    EXCEPTION_BLOCK(float, a, static_cast<float>(args[6]->NumberValue()));
...
static v8::Handle<v8::Value> setShadow4Callback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, height, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, blur, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, c, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, m, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(float, y, static_cast<float>(args[5]->NumberValue()));
    EXCEPTION_BLOCK(float, k, static_cast<float>(args[6]->NumberValue()));
    EXCEPTION_BLOCK(float, a, static_cast<float>(args[7]->NumberValue()));
...
static v8::Handle<v8::Value> createPattern1Callback(const v8::Arguments& args)
{
    ...
    {
    EXCEPTION_BLOCK(HTMLCanvasElement*, canvas, V8HTMLCanvasElement::HasInstance(args[0]) ? V8HTMLCanvasElement::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<WithNullCheck>, repetitionType, args[1]);
...
static v8::Handle<v8::Value> putImageDataCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(ImageData*, imagedata, V8ImageData::HasInstance(args[0]) ? V8ImageData::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    EXCEPTION_BLOCK(float, dx, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, dy, static_cast<float>(args[2]->NumberValue()));
    if (args.Length() <= 3) {
    ...
    EXCEPTION_BLOCK(float, dirtyX, static_cast<float>(args[3]->NumberValue()));
    EXCEPTION_BLOCK(float, dirtyY, static_cast<float>(args[4]->NumberValue()));
    EXCEPTION_BLOCK(float, dirtyWidth, static_cast<float>(args[5]->NumberValue()));
    EXCEPTION_BLOCK(float, dirtyHeight, static_cast<float>(args[6]->NumberValue()));
...
static v8::Handle<v8::Value> createImageData2Callback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(float, sw, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, sh, static_cast<float>(args[1]->NumberValue()));
...
static v8::Handle<v8::Value> getImageDataCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, sx, static_cast<float>(args[0]->NumberValue()));
    EXCEPTION_BLOCK(float, sy, static_cast<float>(args[1]->NumberValue()));
    EXCEPTION_BLOCK(float, sw, static_cast<float>(args[2]->NumberValue()));
    EXCEPTION_BLOCK(float, sh, static_cast<float>(args[3]->NumberValue()));
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CanvasRenderingContext2DTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "CanvasRenderingContext2D", V8CanvasRenderingContext::GetTemplate(), V8CanvasRenderingContext2D::internalFieldCount,
        CanvasRenderingContext2DAttrs, sizeof(CanvasRenderingContext2DAttrs) / sizeof(*CanvasRenderingContext2DAttrs),
        CanvasRenderingContext2DCallbacks, sizeof(CanvasRenderingContext2DCallbacks) / sizeof(*CanvasRenderingContext2DCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    

    // Custom Signature 'drawImageFromRect'
    const int drawImageFromRectArgc = 10;
    v8::Handle<v8::FunctionTemplate> drawImageFromRectArgv[drawImageFromRectArgc] = { V8HTMLImageElement::GetRawTemplate(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>() };
    v8::Handle<v8::Signature> drawImageFromRectSignature = v8::Signature::New(desc, drawImageFromRectArgc, drawImageFromRectArgv);
    proto->Set(v8::String::New("drawImageFromRect"), v8::FunctionTemplate::New(CanvasRenderingContext2DInternal::drawImageFromRectCallback, v8::Handle<v8::Value>(), drawImageFromRectSignature));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8CanvasRenderingContext2DRawCache = createRawTemplate();
    return V8CanvasRenderingContext2DRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8CanvasRenderingContext2D::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8CanvasRenderingContext2DCache = ConfigureV8CanvasRenderingContext2DTemplate(GetRawTemplate());
    return V8CanvasRenderingContext2DCache;
}
