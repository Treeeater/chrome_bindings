...
WrapperTypeInfo V8XMLHttpRequest::info = { V8XMLHttpRequest::GetTemplate, V8XMLHttpRequest::derefObject, V8XMLHttpRequest::toActiveDOMObject };
...
static v8::Handle<v8::Value> setRequestHeaderCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, header, args[0]);
...
static v8::Handle<v8::Value> overrideMimeTypeCallback(const v8::Arguments& args)
{
    ...
    if (args.Length() < 1)
        return throwError("Not enough arguments", V8Proxy::SyntaxError);
    XMLHttpRequest* imp = V8XMLHttpRequest::toNative(args.Holder());
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, override, args[0]);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8XMLHttpRequestTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "XMLHttpRequest", v8::Persistent<v8::FunctionTemplate>(), V8XMLHttpRequest::internalFieldCount,
        XMLHttpRequestAttrs, sizeof(XMLHttpRequestAttrs) / sizeof(*XMLHttpRequestAttrs),
        XMLHttpRequestCallbacks, sizeof(XMLHttpRequestCallbacks) / sizeof(*XMLHttpRequestCallbacks));
    ...
    batchConfigureConstants(desc, proto, XMLHttpRequestConsts, sizeof(XMLHttpRequestConsts) / sizeof(*XMLHttpRequestConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8XMLHttpRequestRawCache = createRawTemplate();
    return V8XMLHttpRequestRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8XMLHttpRequest::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8XMLHttpRequestCache = ConfigureV8XMLHttpRequestTemplate(GetRawTemplate());
    return V8XMLHttpRequestCache;
}
