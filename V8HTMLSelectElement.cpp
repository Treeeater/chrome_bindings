...
WrapperTypeInfo V8HTMLSelectElement::info = { V8HTMLSelectElement::GetTemplate, V8HTMLSelectElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLSelectElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLSelectElement", V8HTMLElement::GetTemplate(), V8HTMLSelectElement::internalFieldCount,
        HTMLSelectElementAttrs, sizeof(HTMLSelectElementAttrs) / sizeof(*HTMLSelectElementAttrs),
        HTMLSelectElementCallbacks, sizeof(HTMLSelectElementCallbacks) / sizeof(*HTMLSelectElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLSelectElementRawCache = createRawTemplate();
    return V8HTMLSelectElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLSelectElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLSelectElementCache = ConfigureV8HTMLSelectElementTemplate(GetRawTemplate());
    return V8HTMLSelectElementCache;
}
