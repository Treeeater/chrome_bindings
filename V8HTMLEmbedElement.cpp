...
WrapperTypeInfo V8HTMLEmbedElement::info = { V8HTMLEmbedElement::GetTemplate, V8HTMLEmbedElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLEmbedElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLEmbedElement", V8HTMLElement::GetTemplate(), V8HTMLEmbedElement::internalFieldCount,
        HTMLEmbedElementAttrs, sizeof(HTMLEmbedElementAttrs) / sizeof(*HTMLEmbedElementAttrs),
        HTMLEmbedElementCallbacks, sizeof(HTMLEmbedElementCallbacks) / sizeof(*HTMLEmbedElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLEmbedElementRawCache = createRawTemplate();
    return V8HTMLEmbedElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLEmbedElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLEmbedElementCache = ConfigureV8HTMLEmbedElementTemplate(GetRawTemplate());
    return V8HTMLEmbedElementCache;
}
