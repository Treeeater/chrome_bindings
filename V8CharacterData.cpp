...
WrapperTypeInfo V8CharacterData::info = { V8CharacterData::GetTemplate, V8CharacterData::derefObject, 0 };
...
static v8::Handle<v8::Value> replaceDataCallback(const v8::Arguments& args)
{
    ...
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, data, args[2]);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CharacterDataTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "CharacterData", V8Node::GetTemplate(), V8CharacterData::internalFieldCount,
        CharacterDataAttrs, sizeof(CharacterDataAttrs) / sizeof(*CharacterDataAttrs),
        CharacterDataCallbacks, sizeof(CharacterDataCallbacks) / sizeof(*CharacterDataCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8CharacterDataRawCache = createRawTemplate();
    return V8CharacterDataRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8CharacterData::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8CharacterDataCache = ConfigureV8CharacterDataTemplate(GetRawTemplate());
    return V8CharacterDataCache;
}
