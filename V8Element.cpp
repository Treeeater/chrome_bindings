...
static v8::Handle<v8::Value> setAttributeNSCallback(const v8::Arguments& args)
{
    ...
    {
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<WithNullCheck>, namespaceURI, args[0]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, qualifiedName, args[1]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, value, args[2]);
...
static v8::Handle<v8::Value> scrollIntoViewCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(bool, alignWithTop, args[0]->BooleanValue());
...
static v8::Handle<v8::Value> scrollIntoViewIfNeededCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(bool, centerIfNeeded, args[0]->BooleanValue());
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8ElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "Element", V8Node::GetTemplate(), V8Element::internalFieldCount,
        ElementAttrs, sizeof(ElementAttrs) / sizeof(*ElementAttrs),
        ElementCallbacks, sizeof(ElementCallbacks) / sizeof(*ElementCallbacks));
    ...
    v8::Handle<v8::FunctionTemplate> containsArgv[containsArgc] = { V8Element::GetRawTemplate() };
    v8::Handle<v8::Signature> containsSignature = v8::Signature::New(desc, containsArgc, containsArgv);
    proto->Set(v8::String::New("contains"), v8::FunctionTemplate::New(ElementInternal::containsCallback, v8::Handle<v8::Value>(), containsSignature));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8ElementRawCache = createRawTemplate();
    return V8ElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8Element::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8ElementCache = ConfigureV8ElementTemplate(GetRawTemplate());
    return V8ElementCache;
}
