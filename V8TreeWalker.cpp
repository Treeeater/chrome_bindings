...
WrapperTypeInfo V8TreeWalker::info = { V8TreeWalker::GetTemplate, V8TreeWalker::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8TreeWalkerTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "TreeWalker", v8::Persistent<v8::FunctionTemplate>(), V8TreeWalker::internalFieldCount,
        TreeWalkerAttrs, sizeof(TreeWalkerAttrs) / sizeof(*TreeWalkerAttrs),
        TreeWalkerCallbacks, sizeof(TreeWalkerCallbacks) / sizeof(*TreeWalkerCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8TreeWalkerRawCache = createRawTemplate();
    return V8TreeWalkerRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8TreeWalker::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8TreeWalkerCache = ConfigureV8TreeWalkerTemplate(GetRawTemplate());
    return V8TreeWalkerCache;
}
