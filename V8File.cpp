...
WrapperTypeInfo V8File::info = { V8File::GetTemplate, V8File::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8FileTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "File", V8Blob::GetTemplate(), V8File::internalFieldCount,
        FileAttrs, sizeof(FileAttrs) / sizeof(*FileAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8FileRawCache = createRawTemplate();
    return V8FileRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8File::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8FileCache = ConfigureV8FileTemplate(GetRawTemplate());
    return V8FileCache;
}
