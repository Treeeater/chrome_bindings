...
V8EntriesCallback::V8EntriesCallback(v8::Local<v8::Object> callback, ScriptExecutionContext* context)
...
bool V8EntriesCallback::handleEvent(EntryArray* entries)
{
    ...
    v8::Handle<v8::Value> entriesHandle = toV8(entries);
