...
WrapperTypeInfo V8HTMLInputElement::info = { V8HTMLInputElement::GetTemplate, V8HTMLInputElement::derefObject, 0 };
...
static v8::Handle<v8::Value> speechAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
...
static void speechAttrSetter(v8::Local<v8::String> name, v8::Local<v8::Value> value, const v8::AccessorInfo& info)
{
    INC_STATS("DOM.HTMLInputElement.speech._set");
    HTMLInputElement* imp = V8HTMLInputElement::toNative(info.Holder());
    bool v = value->BooleanValue();
    imp->setBooleanAttribute(WebCore::HTMLNames::speechAttr, v);
    return;
}
...
static v8::Handle<v8::Value> stepUpCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(int, n, toInt32(args[0]));
    imp->stepUp(n, ec);
    if (UNLIKELY(ec))
        goto fail;
    return v8::Handle<v8::Value>();
...
static const BatchedAttribute HTMLInputElementAttrs[] = {
    ...
    // Attribute 'webkitdirectory' (Type: 'attribute' ExtAttr: 'Reflect')
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLInputElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLInputElement", V8HTMLElement::GetTemplate(), V8HTMLInputElement::internalFieldCount,
        HTMLInputElementAttrs, sizeof(HTMLInputElementAttrs) / sizeof(*HTMLInputElementAttrs),
        HTMLInputElementCallbacks, sizeof(HTMLInputElementCallbacks) / sizeof(*HTMLInputElementCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    if (RuntimeEnabledFeatures::speechEnabled()) {
        static const BatchedAttribute attrData =\
        // Attribute 'speech' (Type: 'attribute' ExtAttr: 'EnabledAtRuntime Reflect')
        {"speech", HTMLInputElementInternal::speechAttrGetter, HTMLInputElementInternal::speechAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */};
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLInputElementRawCache = createRawTemplate();
    return V8HTMLInputElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLInputElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLInputElementCache = ConfigureV8HTMLInputElementTemplate(GetRawTemplate());
    return V8HTMLInputElementCache;
}
