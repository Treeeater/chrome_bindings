...
WrapperTypeInfo V8DOMCoreException::info = { V8DOMCoreException::GetTemplate, V8DOMCoreException::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8DOMCoreExceptionTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "DOMException", v8::Persistent<v8::FunctionTemplate>(), V8DOMCoreException::internalFieldCount,
        DOMCoreExceptionAttrs, sizeof(DOMCoreExceptionAttrs) / sizeof(*DOMCoreExceptionAttrs),
        0, 0);
    ...
    batchConfigureConstants(desc, proto, DOMCoreExceptionConsts, sizeof(DOMCoreExceptionConsts) / sizeof(*DOMCoreExceptionConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8DOMCoreExceptionRawCache = createRawTemplate();
    return V8DOMCoreExceptionRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8DOMCoreException::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8DOMCoreExceptionCache = ConfigureV8DOMCoreExceptionTemplate(GetRawTemplate());
    return V8DOMCoreExceptionCache;
}
