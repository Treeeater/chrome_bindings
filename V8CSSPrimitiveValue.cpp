...
WrapperTypeInfo V8CSSPrimitiveValue::info = { V8CSSPrimitiveValue::GetTemplate, V8CSSPrimitiveValue::derefObject, 0 };
...
static v8::Handle<v8::Value> setFloatValueCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(float, floatValue, static_cast<float>(args[1]->NumberValue()));
...
static v8::Handle<v8::Value> setStringValueCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(int, stringType, toUInt32(args[0]));
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, stringValue, args[1]);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CSSPrimitiveValueTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "CSSPrimitiveValue", V8CSSValue::GetTemplate(), V8CSSPrimitiveValue::internalFieldCount,
        CSSPrimitiveValueAttrs, sizeof(CSSPrimitiveValueAttrs) / sizeof(*CSSPrimitiveValueAttrs),
        CSSPrimitiveValueCallbacks, sizeof(CSSPrimitiveValueCallbacks) / sizeof(*CSSPrimitiveValueCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, CSSPrimitiveValueConsts, sizeof(CSSPrimitiveValueConsts) / sizeof(*CSSPrimitiveValueConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSPrimitiveValueRawCache = createRawTemplate();
    return V8CSSPrimitiveValueRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8CSSPrimitiveValue::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSPrimitiveValueCache = ConfigureV8CSSPrimitiveValueTemplate(GetRawTemplate());
    return V8CSSPrimitiveValueCache;
}
