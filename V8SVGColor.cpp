...
WrapperTypeInfo V8SVGColor::info = { V8SVGColor::GetTemplate, V8SVGColor::derefObject, 0 };
...
static v8::Handle<v8::Value> setRGBColorCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, rgbColor, args[0]);
...
static v8::Handle<v8::Value> setRGBColorICCColorCallback(const v8::Arguments& args)
{
    ...
    {
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, rgbColor, args[0]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, iccColor, args[1]);
...
static v8::Handle<v8::Value> setColorCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(int, colorType, toUInt32(args[0]));
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, rgbColor, args[1]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, iccColor, args[2]);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGColorTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGColor", V8CSSValue::GetTemplate(), V8SVGColor::internalFieldCount,
        SVGColorAttrs, sizeof(SVGColorAttrs) / sizeof(*SVGColorAttrs),
        SVGColorCallbacks, sizeof(SVGColorCallbacks) / sizeof(*SVGColorCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, SVGColorConsts, sizeof(SVGColorConsts) / sizeof(*SVGColorConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGColorRawCache = createRawTemplate();
    return V8SVGColorRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGColor::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGColorCache = ConfigureV8SVGColorTemplate(GetRawTemplate());
    return V8SVGColorCache;
}
