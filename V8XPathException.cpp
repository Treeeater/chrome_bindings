...
WrapperTypeInfo V8XPathException::info = { V8XPathException::GetTemplate, V8XPathException::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8XPathExceptionTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "XPathException", v8::Persistent<v8::FunctionTemplate>(), V8XPathException::internalFieldCount,
        XPathExceptionAttrs, sizeof(XPathExceptionAttrs) / sizeof(*XPathExceptionAttrs),
        0, 0);
    ...
    batchConfigureConstants(desc, proto, XPathExceptionConsts, sizeof(XPathExceptionConsts) / sizeof(*XPathExceptionConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8XPathExceptionRawCache = createRawTemplate();
    return V8XPathExceptionRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8XPathException::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8XPathExceptionCache = ConfigureV8XPathExceptionTemplate(GetRawTemplate());
    return V8XPathExceptionCache;
}
