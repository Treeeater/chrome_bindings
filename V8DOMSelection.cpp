...
WrapperTypeInfo V8DOMSelection::info = { V8DOMSelection::GetTemplate, V8DOMSelection::derefObject, 0 };
...
static v8::Handle<v8::Value> collapseCallback(const v8::Arguments& args)
{
    ...
    EXCEPTION_BLOCK(int, index, toInt32(args[1]));
...
static v8::Handle<v8::Value> containsNodeCallback(const v8::Arguments& args)
{
    ...
    DOMSelection* imp = V8DOMSelection::toNative(args.Holder());
    EXCEPTION_BLOCK(Node*, node, V8Node::HasInstance(args[0]) ? V8Node::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    EXCEPTION_BLOCK(bool, allowPartial, args[1]->BooleanValue());
...
static v8::Handle<v8::Value> addRangeCallback(const v8::Arguments& args)
{
    ...
    DOMSelection* imp = V8DOMSelection::toNative(args.Holder());
    EXCEPTION_BLOCK(Range*, range, V8Range::HasInstance(args[0]) ? V8Range::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    imp->addRange(range);
    return v8::Handle<v8::Value>();
}
...
static v8::Handle<v8::Value> modifyCallback(const v8::Arguments& args)
{
    ...
    DOMSelection* imp = V8DOMSelection::toNative(args.Holder());
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, alter, args[0]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, direction, args[1]);
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK(V8Parameter<>, granularity, args[2]);
...
static v8::Handle<v8::Value> setBaseAndExtentCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(Node*, baseNode, V8Node::HasInstance(args[0]) ? V8Node::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    EXCEPTION_BLOCK(int, baseOffset, toInt32(args[1]));
    EXCEPTION_BLOCK(Node*, extentNode, V8Node::HasInstance(args[2]) ? V8Node::toNative(v8::Handle<v8::Object>::Cast(args[2])) : 0);
    EXCEPTION_BLOCK(int, extentOffset, toInt32(args[3]));
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8DOMSelectionTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "DOMSelection", v8::Persistent<v8::FunctionTemplate>(), V8DOMSelection::internalFieldCount,
        DOMSelectionAttrs, sizeof(DOMSelectionAttrs) / sizeof(*DOMSelectionAttrs),
        DOMSelectionCallbacks, sizeof(DOMSelectionCallbacks) / sizeof(*DOMSelectionCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8DOMSelectionRawCache = createRawTemplate();
    return V8DOMSelectionRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8DOMSelection::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8DOMSelectionCache = ConfigureV8DOMSelectionTemplate(GetRawTemplate());
    return V8DOMSelectionCache;
}
