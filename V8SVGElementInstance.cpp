...
WrapperTypeInfo V8SVGElementInstance::info = { V8SVGElementInstance::GetTemplate, V8SVGElementInstance::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGElementInstanceTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGElementInstance", v8::Persistent<v8::FunctionTemplate>(), V8SVGElementInstance::internalFieldCount,
        SVGElementInstanceAttrs, sizeof(SVGElementInstanceAttrs) / sizeof(*SVGElementInstanceAttrs),
        SVGElementInstanceCallbacks, sizeof(SVGElementInstanceCallbacks) / sizeof(*SVGElementInstanceCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGElementInstanceRawCache = createRawTemplate();
    return V8SVGElementInstanceRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGElementInstance::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGElementInstanceCache = ConfigureV8SVGElementInstanceTemplate(GetRawTemplate());
    return V8SVGElementInstanceCache;
}

SVGElementInstance* V8SVGElementInstance::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Object> V8SVGElementInstance::wrap(SVGElementInstance* impl)
{
    ...
    V8Proxy* proxy = 0;
        wrapper = getDOMSVGElementInstanceMap().get(impl);
        if (!wrapper.IsEmpty())
            return wrapper;
    ...
    impl->ref();
    getDOMSVGElementInstanceMap().set(impl, v8::Persistent<v8::Object>::New(wrapper));
    return wrapper;
}

v8::Handle<v8::Value> toV8(PassRefPtr<SVGElementInstance > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(SVGElementInstance* impl)
{
    if (!impl)
        return v8::Null();
