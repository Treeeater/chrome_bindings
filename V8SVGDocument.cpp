...
WrapperTypeInfo V8SVGDocument::info = { V8SVGDocument::GetTemplate, V8SVGDocument::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGDocumentTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGDocument", V8Document::GetTemplate(), V8SVGDocument::internalFieldCount,
        SVGDocumentAttrs, sizeof(SVGDocumentAttrs) / sizeof(*SVGDocumentAttrs),
        SVGDocumentCallbacks, sizeof(SVGDocumentCallbacks) / sizeof(*SVGDocumentCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGDocumentRawCache = createRawTemplate();
    return V8SVGDocumentRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGDocument::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGDocumentCache = ConfigureV8SVGDocumentTemplate(GetRawTemplate());
    return V8SVGDocumentCache;
}
