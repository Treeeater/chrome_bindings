...
WrapperTypeInfo V8FileWriter::info = { V8FileWriter::GetTemplate, V8FileWriter::derefObject, 0 };
...
static v8::Handle<v8::Value> writeCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(Blob*, data, V8Blob::HasInstance(args[0]) ? V8Blob::toNative(v8::Handle<v8::Object>::Cast(args[0])) : 0);
    imp->write(data, ec);
    if (UNLIKELY(ec))
        goto fail;
...
static v8::Handle<v8::Value> seekCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(long long, position, toInt64(args[0]));
...
static v8::Handle<v8::Value> truncateCallback(const v8::Arguments& args)
{
    ...
    ExceptionCode ec = 0;
    {
    EXCEPTION_BLOCK(long long, size, toInt64(args[0]));
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8FileWriterTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "FileWriter", v8::Persistent<v8::FunctionTemplate>(), V8FileWriter::internalFieldCount,
        FileWriterAttrs, sizeof(FileWriterAttrs) / sizeof(*FileWriterAttrs),
        FileWriterCallbacks, sizeof(FileWriterCallbacks) / sizeof(*FileWriterCallbacks));
    ...
    batchConfigureConstants(desc, proto, FileWriterConsts, sizeof(FileWriterConsts) / sizeof(*FileWriterConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8FileWriterRawCache = createRawTemplate();
    return V8FileWriterRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8FileWriter::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8FileWriterCache = ConfigureV8FileWriterTemplate(GetRawTemplate());
    return V8FileWriterCache;
}

FileWriter* V8FileWriter::toNative(v8::Handle<v8::Object> object)
{
    return reinterpret_cast<FileWriter*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
}
...
v8::Handle<v8::Object> V8FileWriter::wrap(FileWriter* impl)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<FileWriter > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(FileWriter* impl)
{
    if (!impl)
        return v8::Null();
    return V8FileWriter::wrap(impl);
}
