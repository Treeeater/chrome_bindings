...
WrapperTypeInfo V8SVGAElement::info = { V8SVGAElement::GetTemplate, V8SVGAElement::derefObject, 0 };
...
static v8::Handle<v8::Value> targetAttrGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info)
{
    ...
    PassRefPtr<SVGAnimatedString> resultAsPassRefPtr = V8Proxy::withSVGContext(imp->targetAnimated(), context);
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8SVGAElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "SVGAElement", V8SVGElement::GetTemplate(), V8SVGAElement::internalFieldCount,
        SVGAElementAttrs, sizeof(SVGAElementAttrs) / sizeof(*SVGAElementAttrs),
        SVGAElementCallbacks, sizeof(SVGAElementCallbacks) / sizeof(*SVGAElementCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGAElementRawCache = createRawTemplate();
    return V8SVGAElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8SVGAElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGAElementCache = ConfigureV8SVGAElementTemplate(GetRawTemplate());
    return V8SVGAElementCache;
}

SVGAElement* V8SVGAElement::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<SVGAElement > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(SVGAElement* impl)
{
    if (!impl)
        return v8::Null();
