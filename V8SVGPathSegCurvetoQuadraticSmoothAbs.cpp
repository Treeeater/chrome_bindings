...
WrapperTypeInfo V8SVGPathSegCurvetoQuadraticSmoothAbs::info = { V8SVGPathSegCurvetoQuadraticSmoothAbs::GetTemplate, V8SVGPathSegCurvetoQuadraticSmoothAbs::derefObject, 0 };
...
{
    static v8::Persistent<v8::FunctionTemplate> V8SVGPathSegCurvetoQuadraticSmoothAbsCache = ConfigureV8SVGPathSegCurvetoQuadraticSmoothAbsTemplate(GetRawTemplate());
    return V8SVGPathSegCurvetoQuadraticSmoothAbsCache;
}

SVGPathSegCurvetoQuadraticSmoothAbs* V8SVGPathSegCurvetoQuadraticSmoothAbs::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(SVGPathSegCurvetoQuadraticSmoothAbs* impl)
{
    if (!impl)
        return v8::Null();
