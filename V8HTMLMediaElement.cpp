...
WrapperTypeInfo V8HTMLMediaElement::info = { V8HTMLMediaElement::GetTemplate, V8HTMLMediaElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLMediaElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLMediaElement", V8HTMLElement::GetTemplate(), V8HTMLMediaElement::internalFieldCount,
        HTMLMediaElementAttrs, sizeof(HTMLMediaElementAttrs) / sizeof(*HTMLMediaElementAttrs),
        HTMLMediaElementCallbacks, sizeof(HTMLMediaElementCallbacks) / sizeof(*HTMLMediaElementCallbacks));
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, HTMLMediaElementConsts, sizeof(HTMLMediaElementConsts) / sizeof(*HTMLMediaElementConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLMediaElementRawCache = createRawTemplate();
    return V8HTMLMediaElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLMediaElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLMediaElementCache = ConfigureV8HTMLMediaElementTemplate(GetRawTemplate());
    return V8HTMLMediaElementCache;
}
