...
WrapperTypeInfo V8WebKitCSSTransformValue::info = { V8WebKitCSSTransformValue::GetTemplate, V8WebKitCSSTransformValue::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8WebKitCSSTransformValueTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "WebKitCSSTransformValue", V8CSSValueList::GetTemplate(), V8WebKitCSSTransformValue::internalFieldCount,
        WebKitCSSTransformValueAttrs, sizeof(WebKitCSSTransformValueAttrs) / sizeof(*WebKitCSSTransformValueAttrs),
        0, 0);
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, WebKitCSSTransformValueConsts, sizeof(WebKitCSSTransformValueConsts) / sizeof(*WebKitCSSTransformValueConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8WebKitCSSTransformValueRawCache = createRawTemplate();
    return V8WebKitCSSTransformValueRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8WebKitCSSTransformValue::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8WebKitCSSTransformValueCache = ConfigureV8WebKitCSSTransformValueTemplate(GetRawTemplate());
    return V8WebKitCSSTransformValueCache;
}
