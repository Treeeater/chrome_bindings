...
WrapperTypeInfo V8FileList::info = { V8FileList::GetTemplate, V8FileList::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8FileListTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "FileList", v8::Persistent<v8::FunctionTemplate>(), V8FileList::internalFieldCount,
        FileListAttrs, sizeof(FileListAttrs) / sizeof(*FileListAttrs),
        FileListCallbacks, sizeof(FileListCallbacks) / sizeof(*FileListCallbacks));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8FileListRawCache = createRawTemplate();
    return V8FileListRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8FileList::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8FileListCache = ConfigureV8FileListTemplate(GetRawTemplate());
    return V8FileListCache;
}
