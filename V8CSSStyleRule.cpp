...
WrapperTypeInfo V8CSSStyleRule::info = { V8CSSStyleRule::GetTemplate, V8CSSStyleRule::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CSSStyleRuleTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "CSSStyleRule", V8CSSRule::GetTemplate(), V8CSSStyleRule::internalFieldCount,
        CSSStyleRuleAttrs, sizeof(CSSStyleRuleAttrs) / sizeof(*CSSStyleRuleAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSStyleRuleRawCache = createRawTemplate();
    return V8CSSStyleRuleRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8CSSStyleRule::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSStyleRuleCache = ConfigureV8CSSStyleRuleTemplate(GetRawTemplate());
    return V8CSSStyleRuleCache;
}
