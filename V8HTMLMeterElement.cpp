...
WrapperTypeInfo V8HTMLMeterElement::info = { V8HTMLMeterElement::GetTemplate, V8HTMLMeterElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLMeterElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLMeterElement", V8HTMLElement::GetTemplate(), V8HTMLMeterElement::internalFieldCount,
        HTMLMeterElementAttrs, sizeof(HTMLMeterElementAttrs) / sizeof(*HTMLMeterElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLMeterElementRawCache = createRawTemplate();
    return V8HTMLMeterElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLMeterElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLMeterElementCache = ConfigureV8HTMLMeterElementTemplate(GetRawTemplate());
    return V8HTMLMeterElementCache;
}

HTMLMeterElement* V8HTMLMeterElement::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<HTMLMeterElement > impl)
{
    return toV8(impl.get());
}

v8::Handle<v8::Value> toV8(HTMLMeterElement* impl)
{
    if (!impl)
        return v8::Null();
