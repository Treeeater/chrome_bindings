...
WrapperTypeInfo V8MediaError::info = { V8MediaError::GetTemplate, V8MediaError::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8MediaErrorTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "MediaError", v8::Persistent<v8::FunctionTemplate>(), V8MediaError::internalFieldCount,
        MediaErrorAttrs, sizeof(MediaErrorAttrs) / sizeof(*MediaErrorAttrs),
        0, 0);
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, MediaErrorConsts, sizeof(MediaErrorConsts) / sizeof(*MediaErrorConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8MediaErrorRawCache = createRawTemplate();
    return V8MediaErrorRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8MediaError::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8MediaErrorCache = ConfigureV8MediaErrorTemplate(GetRawTemplate());
    return V8MediaErrorCache;
}
