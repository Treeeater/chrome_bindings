...
WrapperTypeInfo V8CSSFontFaceRule::info = { V8CSSFontFaceRule::GetTemplate, V8CSSFontFaceRule::derefObject, 0 };
...
static const BatchedAttribute CSSFontFaceRuleAttrs[] = {
    // Attribute 'style' (Type: 'readonly attribute' ExtAttr: '')
    {"style", CSSFontFaceRuleInternal::styleAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CSSFontFaceRuleTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "CSSFontFaceRule", V8CSSRule::GetTemplate(), V8CSSFontFaceRule::internalFieldCount,
        CSSFontFaceRuleAttrs, sizeof(CSSFontFaceRuleAttrs) / sizeof(*CSSFontFaceRuleAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSFontFaceRuleRawCache = createRawTemplate();
    return V8CSSFontFaceRuleRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8CSSFontFaceRule::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8CSSFontFaceRuleCache = ConfigureV8CSSFontFaceRuleTemplate(GetRawTemplate());
    return V8CSSFontFaceRuleCache;
}
...
{
    static_cast<CSSFontFaceRule*>(object)->deref();
}
