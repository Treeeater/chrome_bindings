...
WrapperTypeInfo V8ProcessingInstruction::info = { V8ProcessingInstruction::GetTemplate, V8ProcessingInstruction::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8ProcessingInstructionTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "ProcessingInstruction", V8Node::GetTemplate(), V8ProcessingInstruction::internalFieldCount,
        ProcessingInstructionAttrs, sizeof(ProcessingInstructionAttrs) / sizeof(*ProcessingInstructionAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8ProcessingInstructionRawCache = createRawTemplate();
    return V8ProcessingInstructionRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8ProcessingInstruction::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8ProcessingInstructionCache = ConfigureV8ProcessingInstructionTemplate(GetRawTemplate());
    return V8ProcessingInstructionCache;
}

ProcessingInstruction* V8ProcessingInstruction::toNative(v8::Handle<v8::Object> object)
{
...
v8::Handle<v8::Value> toV8(PassRefPtr<ProcessingInstruction > impl, bool forceNewObject)
{
    return toV8(impl.get(), forceNewObject);
}

v8::Handle<v8::Value> toV8(ProcessingInstruction* impl, bool forceNewObject)
{
    if (!impl)
        return v8::Null();
