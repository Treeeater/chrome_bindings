...
WrapperTypeInfo V8HTMLTableCellElement::info = { V8HTMLTableCellElement::GetTemplate, V8HTMLTableCellElement::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLTableCellElementTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "HTMLTableCellElement", V8HTMLElement::GetTemplate(), V8HTMLTableCellElement::internalFieldCount,
        HTMLTableCellElementAttrs, sizeof(HTMLTableCellElementAttrs) / sizeof(*HTMLTableCellElementAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLTableCellElementRawCache = createRawTemplate();
    return V8HTMLTableCellElementRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLTableCellElement::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8HTMLTableCellElementCache = ConfigureV8HTMLTableCellElementTemplate(GetRawTemplate());
    return V8HTMLTableCellElementCache;
}
