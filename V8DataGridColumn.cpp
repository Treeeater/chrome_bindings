...
WrapperTypeInfo V8DataGridColumn::info = { V8DataGridColumn::GetTemplate, V8DataGridColumn::derefObject, 0 };
...
static const BatchedAttribute DataGridColumnAttrs[] = {
    // Attribute 'id' (Type: 'attribute' ExtAttr: '')
    {"id", DataGridColumnInternal::idAttrGetter, DataGridColumnInternal::idAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'label' (Type: 'attribute' ExtAttr: '')
    {"label", DataGridColumnInternal::labelAttrGetter, DataGridColumnInternal::labelAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'type' (Type: 'attribute' ExtAttr: '')
    {"type", DataGridColumnInternal::typeAttrGetter, DataGridColumnInternal::typeAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'sortable' (Type: 'attribute' ExtAttr: '')
    {"sortable", DataGridColumnInternal::sortableAttrGetter, DataGridColumnInternal::sortableAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'sortDirection' (Type: 'attribute' ExtAttr: '')
    {"sortDirection", DataGridColumnInternal::sortDirectionAttrGetter, DataGridColumnInternal::sortDirectionAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
    // Attribute 'primary' (Type: 'attribute' ExtAttr: '')
    {"primary", DataGridColumnInternal::primaryAttrGetter, DataGridColumnInternal::primaryAttrSetter, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
static const BatchedConstant DataGridColumnConsts[] = {
...
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "DataGridColumn", v8::Persistent<v8::FunctionTemplate>(), V8DataGridColumn::internalFieldCount,
        DataGridColumnAttrs, sizeof(DataGridColumnAttrs) / sizeof(*DataGridColumnAttrs),
        0, 0);
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, DataGridColumnConsts, sizeof(DataGridColumnConsts) / sizeof(*DataGridColumnConsts));
...
{
    static v8::Persistent<v8::FunctionTemplate> V8DataGridColumnRawCache = createRawTemplate();
    return V8DataGridColumnRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8DataGridColumn::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8DataGridColumnCache = ConfigureV8DataGridColumnTemplate(GetRawTemplate());
    return V8DataGridColumnCache;
}
...
void V8DataGridColumn::derefObject(void* object)
{
    static_cast<DataGridColumn*>(object)->deref();
}
