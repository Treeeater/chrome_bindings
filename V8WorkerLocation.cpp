...
WrapperTypeInfo V8WorkerLocation::info = { V8WorkerLocation::GetTemplate, V8WorkerLocation::derefObject, 0 };
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8WorkerLocationTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "WorkerLocation", v8::Persistent<v8::FunctionTemplate>(), V8WorkerLocation::internalFieldCount,
        WorkerLocationAttrs, sizeof(WorkerLocationAttrs) / sizeof(*WorkerLocationAttrs),
        0, 0);
...
{
    static v8::Persistent<v8::FunctionTemplate> V8WorkerLocationRawCache = createRawTemplate();
    return V8WorkerLocationRawCache;
}

v8::Persistent<v8::FunctionTemplate> V8WorkerLocation::GetTemplate()
{
    static v8::Persistent<v8::FunctionTemplate> V8WorkerLocationCache = ConfigureV8WorkerLocationTemplate(GetRawTemplate());
    return V8WorkerLocationCache;
}
